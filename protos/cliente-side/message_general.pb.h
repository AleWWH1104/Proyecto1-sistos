...
#ifndef cliente_2dside_2fmessage_5fgeneral_2eproto_2epb_2eh
#define cliente_2dside_2fmessage_5fgeneral_2eproto_2epb_2eh
...
extern "C" {
extern const ::google::protobuf::internal::DescriptorTable descriptor_table_cliente_2dside_2fmessage_5fgeneral_2eproto;
}  // extern "C"
namespace chat {
...
class  PROTOBUF_FUTURE_ADD_EARLY_WARN_UNUSED MessageGeneral final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:chat.MessageGeneral) */ {
 public:
  ...
  explicit constexpr MessageGeneral(::google::protobuf::internal::ConstantInitialized);
  ...
  [[nodiscard]] static const MessageGeneral& default_instance() {
  ...
  [[nodiscard]] MessageGeneral* PROTOBUF_NONNULL
 ...
 public:
  ...
  [[nodiscard]] const ::std::string& username_origin() const;
  template <typename Arg_ = const ::std::string&, typename... Args_>
  ...
  void clear_status() ;
  [[nodiscard]] ::chat::StatusEnum status() const;
...
#endif  // cliente_2dside_2fmessage_5fgeneral_2eproto_2epb_2eh
