...
#ifndef cliente_2dside_2fquit_2eproto_2epb_2eh
#define cliente_2dside_2fquit_2eproto_2epb_2eh
...
extern "C" {
extern const ::google::protobuf::internal::DescriptorTable descriptor_table_cliente_2dside_2fquit_2eproto;
}  // extern "C"
namespace chat {
class Quit;
...
class  PROTOBUF_FUTURE_ADD_EARLY_WARN_UNUSED Quit final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:chat.Quit) */ {
 public:
  ...
  explicit constexpr Quit(::google::protobuf::internal::ConstantInitialized);
  ...
  [[nodiscard]] static const Quit& default_instance() {
  ...
  [[nodiscard]] Quit* PROTOBUF_NONNULL
...
#endif  // cliente_2dside_2fquit_2eproto_2epb_2eh
