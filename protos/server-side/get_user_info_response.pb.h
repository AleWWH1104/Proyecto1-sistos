...
class  PROTOBUF_FUTURE_ADD_EARLY_WARN_UNUSED GetUserInfoResponse final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:chat.GetUserInfoResponse) */ {
 public:
  ...
  explicit constexpr GetUserInfoResponse(::google::protobuf::internal::ConstantInitialized);
  ...
  [[nodiscard]] static const GetUserInfoResponse& default_instance() {
  ...
  [[nodiscard]] GetUserInfoResponse* PROTOBUF_NONNULL
