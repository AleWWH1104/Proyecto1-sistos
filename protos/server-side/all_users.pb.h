...
class  PROTOBUF_FUTURE_ADD_EARLY_WARN_UNUSED AllUsers final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:chat.AllUsers) */ {
 public:
  ...
  explicit constexpr AllUsers(::google::protobuf::internal::ConstantInitialized);
  ...
  [[nodiscard]] static const AllUsers& default_instance() {
  ...
  [[nodiscard]] AllUsers* PROTOBUF_NONNULL
 ...
 public:
  ...
  void clear_status() ;
  public:
  [[nodiscard]] ::chat::StatusEnum status(int index) const;
  void set_status(int index, ::chat::StatusEnum value);
  void add_status(::chat::StatusEnum value);
  [[nodiscard]] const ::google::protobuf::RepeatedField<int>& status() const;
  [[nodiscard]] ::google::protobuf::RepeatedField<int>* PROTOBUF_NONNULL mutable_status();
