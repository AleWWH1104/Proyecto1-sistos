...
class  PROTOBUF_FUTURE_ADD_EARLY_WARN_UNUSED ServerResponse final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:chat.ServerResponse) */ {
 public:
  ...
  explicit constexpr ServerResponse(::google::protobuf::internal::ConstantInitialized);
  ...
  [[nodiscard]] static const ServerResponse& default_instance() {
  ...
  [[nodiscard]] ServerResponse* PROTOBUF_NONNULL
